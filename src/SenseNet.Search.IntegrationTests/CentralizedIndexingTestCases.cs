...
namespace SenseNet.Search.IntegrationTests
{
    public abstract class CentralizedIndexingTestCases : IntegrationTestBase
    {
        ...
        protected async Task Indexing_Centralized_UpdateStateToDone()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate01_SelectWaiting()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate02_IdDependency()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate02_IdDependency_VersionId0()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate03_InactiveDependency()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate04_SelectMore()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate05_PathDependency()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate06_Timeout()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate07_MaxRecords()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_Allocate08_StateUpdated()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_AllocateAndState()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_RefreshLock()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
        ...
        protected async Task Indexing_Centralized_DeleteFinished()
        {
            await NoRepositoryIntegrtionTest(async () =>
            {
                await DP.DeleteAllIndexingActivitiesAsync(CancellationToken.None);
